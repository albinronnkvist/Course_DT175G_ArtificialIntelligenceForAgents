...
import me.albinronnkvist.adversarial.agents.MiniMaxAgent;
...
public class Game {
    private final Player max = new Player("MAX", Symbol.X, PlayerType.AGENT);
    private final Player min = new Player("MIN", Symbol.O, PlayerType.HUMAN);
